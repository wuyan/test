...
$query = "SELECT * FROM orderform where status=2";
$result = mysql_query($query) or die("SQL Error 1: " . mysql_error());
while ($row = mysql_fetch_array($result, MYSQL_ASSOC)) {
$a="<a href=huanjianyishou.php?id=".$row['id']."><font color=#3399FF>下一步坏件已收</a>";
$b="<a href=huanjianzaituedit.php?id=".$row['id']." ><font color=#3399FF>编辑</font></a>";
$c="<a href=huanjianzaitudel.php?id=".$row['id']." ><font color=#3399FF>删除</font></a>";

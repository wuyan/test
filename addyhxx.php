...
<?php        
    ...
    <body>
		  ...
		  <form  name='form' method='post' action="addyhxx1.php" id="jiahe">
            <div style="height:300px;width:500px;border:1px solid #66CCFF;margin:100 auto;">
                <div style="margin-top:50px;height:30px;">
                    ...
                    <input name="customer" type="text"  style="width:155px;" 
					    ></input>
                ...
                <div style="margin-top:10px;height:30px;">
                    ...
                    <div style="float:left;margin-left:45px;">
			          <input name="telephone"  type="text" style="width:155px;" 
					    ></input>
                    </div>
                </div>
					<div style="margin-top:10px;height:30px;">
                    ...
                    <div style="float:left;margin-left:45px;">
                          <input name="email" type="text" style="width:155px;" 
					    ></input>
                    </div>
                </div>
